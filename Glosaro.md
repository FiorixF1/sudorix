...
| Column                                    | Kolumno                                   |
| Box, block                                | Bloko                                     |
| Unit, sector, house                       | Unuo, sektoro, domo                       |
| Line                                      | Linio                                     |
| Intersection                              | Intersekco                                |
| Mini-line                                 | Linieto                                   |
| Cell                                      | Ĉelo                                      |
| - To fill a cell                          | - Plenigi ĉelon                           |
| Given, clue                               | Donitaĵo, indico                          |
| Digit, value                              | Cifero, valoro                            |
| Candidate, mark, sign                     | Kandidato, marko, signo                   |
| Peer                                      | Samunuano                                 |
| Naked / Hidden subset                     | Nuda / Kaŝita subaro                      |
| - Naked / Hidden single                   | - Nuda / Kaŝita unuopo                    |
| - Naked / Hidden pair                     | - Nuda / Kaŝita duopo                     |
...
| - Two-String Kite                         | - Dukorda kajto                           |
| - Crane                                   | - Gruo                                    |
| - Empty Rectangle                         | - Malplena rektangulo                     |
| - Remote Pair                             | - Fora duopo                              |
| - X-Chain                                 | - X-Ĉeno                                  |
| - XY-Chain                                | - XY-Ĉeno                                 |
| - Alternating Inference Chain             | - Alterna Inferenca Ĉeno                  |
| - Grouped Alternating Inference Chain     | - Grupigita Alterna Inferenca Ĉeno        |
