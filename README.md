...
* **30719** enigmojn el **31512** el `Just17.txt`

* **165** enigmojn el **50000** el `top50000.txt`
...
- `int sudorix_solver_next_step(uint32_t *out, uint32_t out_words)`
  ...
  - `out[0]=type`, `out[1]=reasonId`, `out[2]=fromPrev`, `out[3]=opCount`, `out[4]=srcCount`, `out[..srcCount..]=idx/mask`, `out[..opCount..]=idx/mask`
